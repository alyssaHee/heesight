    ...
    return (
        <div className="overlay">
            ...
            <div className="overlay-info-container">
                ...
                <p className={`loading-text ${isRevealed ? 'revealed' : ''} small-overlay-text hide-on-mobile hide-on-desktop`}>This website is not optimized for mobile view. Please rotate to landscape mode for the best experience and tap and drag to navigate!</p>
